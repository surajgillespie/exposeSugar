define(function (require) {
    ...
    datastore.getMetadata = function (objectId, callback) {
        ...
        //console.log(datastore.get_meta);
    };
    ...
    datastore.load = function (objectId, callback) {
        ...
        inputStream.open(function (error) {
            ...
            bus.sendMessage("datastore.load", params,null);
            console.log("before");
            //bus.sendMessage("sugar.logger",params,onResponseReceived);
            console.log("after");
        });
    };
